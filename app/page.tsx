  ...
  const tools = [
    {
      ...
      icon: "🎨",
      href: "/filters",
      gradient: "bg-gradient-to-br from-purple-600 via-purple-500 to-indigo-600",
    ...
    },
    {
      ...
      icon: "📦",
      href: "/compressor",
      gradient: "bg-gradient-to-br from-teal-600 via-teal-500 to-emerald-600",
    ...
    },
    {
      ...
      icon: "🔄",
      href: "/rotate",
      gradient: "bg-gradient-to-br from-rose-600 via-rose-500 to-pink-600",
